...
def detectPlate():
        ...
        if request.method=='POST':
                ...
                gray_car_image = resize(gray_car_image, (500,500))
                gray_car_image = rgb2gray(gray_car_image)
        ...
        if(flag == 1):
            ...
            # plt.show()
                plt.axis('off')
                plt.savefig('plate_identify.png',bbox_inches='tight')
        if(flag==0):
...
def segmentCharacters():
        if request.method=='POST':
                car_image = imread('plate_identify.png')
                ...
                for regions in regionprops(labelled_plate):
                    ...
                    if region_height > min_height and region_width > min_width:
